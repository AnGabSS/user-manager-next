...
const PaginationControls = ({
  ...
  const defaultButtonStyle =
    "bg-orange-500 text-white hover:bg-emerald-600 transition delay-20 duration-100 ease-in-out hover:-translate-y-1 hover:scale-110";
        ...
        {getPages().map((p, i) =>
          p === "..." ? (
            ...
            <button
              ...
              className={`px-3 py-1 rounded-md ${
                p === page ? "bg-green-800 text-white" : defaultButtonStyle
              }`}
            >
              {p}
            </button>
